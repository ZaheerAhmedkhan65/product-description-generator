...
class Settings {
    ...
    defaultSettings() {
        return {
            ...
            customPrompt: this.defaultPrompt()
        };
    }


    defaultPrompt() {
        return `You are an expert marketplace product copywriter specializing in medical and surgical products for online sales platforms.
...
<text>`;
    ...
    async broadcastSettings() {
        try {
            ...
            const tabs = await chrome.tabs.query({ url: 'https://onlinesalepoint.com/shop/products/*' });
